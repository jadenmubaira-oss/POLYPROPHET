...
const CONFIG = {
    ...
    TIMEFRAMES: [
        { key: '5m', seconds: 300, label: '5-Minute', enabled: microBankrollDeployProfile ? false : parseBool(process.env.TIMEFRAME_5M_ENABLED ?? process.env.MULTIFRAME_5M_ENABLED, false), minBankroll: parseNumber(process.env.TIMEFRAME_5M_MIN_BANKROLL, 50) },
    ...
    RISK: {
        ...
        maxConsecutiveLosses: parseNumber(process.env.MAX_CONSECUTIVE_LOSSES, 999),
        cooldownSeconds: parseNumber(process.env.COOLDOWN_SECONDS, 0),

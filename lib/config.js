...
const CONFIG = {
    ...
    RISK: {
        ...
        redemptionDustUsd: parseNumber(process.env.REDEMPTION_DUST_USD, 0.01),
        ...
        minEntrySecondsBeforeClose: {
            '5m': parseNumber(process.env.MIN_ENTRY_SECONDS_BEFORE_CLOSE_5M, 45),
            '15m': parseNumber(process.env.MIN_ENTRY_SECONDS_BEFORE_CLOSE_15M, 120),
            '4h': parseNumber(process.env.MIN_ENTRY_SECONDS_BEFORE_CLOSE_4H, 600),
        },
        maxMatchedSharesMultiplier: parseNumber(process.env.MAX_MATCHED_SHARES_MULTIPLIER, 1.05),
        intracycleWatchdogEnabled: parseBool(process.env.INTRACYCLE_WATCHDOG_ENABLED, true),
        intracycleWatchdogMinAgeSeconds: parseNumber(process.env.INTRACYCLE_WATCHDOG_MIN_AGE_SECONDS, 60),
        intracycleWatchdogMinExitBid: parseNumber(process.env.INTRACYCLE_WATCHDOG_MIN_EXIT_BID, 0.10),
        intracycleWatchdogMinExitUsd: parseNumber(process.env.INTRACYCLE_WATCHDOG_MIN_EXIT_USD, 1.00),
        intracycleWatchdogTakeProfitBid: parseNumber(process.env.INTRACYCLE_WATCHDOG_TAKE_PROFIT_BID, 0.90),
        intracycleWatchdogPeakMinGainCents: parseNumber(process.env.INTRACYCLE_WATCHDOG_PEAK_MIN_GAIN_CENTS, 12),
        intracycleWatchdogTrailingDropCents: parseNumber(process.env.INTRACYCLE_WATCHDOG_TRAILING_DROP_CENTS, 7),
        intracycleWatchdogLockProfitCents: parseNumber(process.env.INTRACYCLE_WATCHDOG_LOCK_PROFIT_CENTS, 3),
        intracycleWatchdogStopLossBid: parseNumber(process.env.INTRACYCLE_WATCHDOG_STOP_LOSS_BID, 0.16),
        intracycleWatchdogStopLossRoi: parseNumber(process.env.INTRACYCLE_WATCHDOG_STOP_LOSS_ROI, -0.65),
    },

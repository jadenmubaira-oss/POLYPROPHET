require('dotenv').config();
 ...
 const CONFIG = {
    ...
    RISK: {
        ...
        maxAbsoluteStakeSmall: parseNumber(process.env.MAX_ABSOLUTE_STAKE_SMALL ?? process.env.MAX_ABSOLUTE_POSITION_SIZE, 100),
        maxAbsoluteStakeMedium: parseNumber(process.env.MAX_ABSOLUTE_STAKE_MEDIUM, 200),
        maxAbsoluteStakeLarge: parseNumber(process.env.MAX_ABSOLUTE_STAKE_LARGE, 500),
    },

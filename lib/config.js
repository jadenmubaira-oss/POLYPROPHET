...
const phase3StakeFraction = parseNumber(process.env.PHASE3_STAKE_FRACTION, 0);
const defaultStakeFraction = phase3StakeFraction > 0 ? phase3StakeFraction : (startingBalance <= 10 ? 0.15 : 0.12);

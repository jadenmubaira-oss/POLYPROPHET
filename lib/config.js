require('dotenv').config();
 ...
 const defaultStakeFraction = startingBalance <= 10 ? 0.30 : 0.20;
...
const CONFIG = {
    ...
    TIMEFRAMES: [
        { key: '5m', seconds: 300, label: '5-Minute', enabled: parseBool(process.env.TIMEFRAME_5M_ENABLED ?? process.env.MULTIFRAME_5M_ENABLED, false) },
        { key: '15m', seconds: 900, label: '15-Minute', enabled: parseBool(process.env.TIMEFRAME_15M_ENABLED, true) },
        { key: '4h', seconds: 14400, label: '4-Hour', enabled: parseBool(process.env.MULTIFRAME_4H_ENABLED ?? process.env.ENABLE_4H_TRADING, false) }
    ],
    ...
    RISK: {
        ...
        kellyMaxFraction: parseFloat(process.env.KELLY_MAX_FRACTION || process.env.MAX_POSITION_SIZE || '0.45'),

require('dotenv').config();
 ...
 const defaultStakeFraction = startingBalance <= 10 ? 0.45 : 0.20;
 ...
 const CONFIG = {
    ...
    TIMEFRAMES: [
        ...
        { key: '15m', seconds: 900, label: '15-Minute', enabled: parseBool(process.env.TIMEFRAME_15M_ENABLED, true), minBankroll: 0 },
        { key: '4h', seconds: 14400, label: '4-Hour', enabled: parseBool(process.env.MULTIFRAME_4H_ENABLED ?? process.env.ENABLE_4H_TRADING, false), minBankroll: parseNumber(process.env.TIMEFRAME_4H_MIN_BANKROLL, 4) }
    ],

...
function installClobAxiosRouting() {
    ...
    axios.interceptors.request.use((requestConfig) => {
        ...
        // Always try direct first for CLOB calls.
        // CLOB read endpoints are confirmed not geoblocked.
        // Authenticated endpoints may be geoblocked from some regions,
        // but the proxy is currently dead/unreliable so direct is the best option.

  ...
  async _deriveApiCredsFor(sigType, funder, label, timeoutMs = 20000) {
    ...
    try {
      ...
      const tmp = new ClobClient({
        host,
        chain: POLY_CHAIN_ID,
        // Keep the SDK signer as the real private-key wallet. For sigType=3 the
        // V2 order builder uses funderAddress as maker/order-signer, while the
        // EOA/private-key wallet produces the EIP-712 signature.
        signer: this.wallet,

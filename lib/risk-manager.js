...
class RiskManager {
    ...
    _getTierProfile(bankroll) {
        if (bankroll < 10) return { maxPerCycle: 3, stakeFraction: 0.15, label: 'BOOTSTRAP' };
        if (bankroll < 50) return { maxPerCycle: 3, stakeFraction: 0.15, label: 'GROWTH' };
        if (bankroll < 200) return { maxPerCycle: 3, stakeFraction: 0.15, label: 'ACCELERATE' };
        return { maxPerCycle: 3, stakeFraction: 0.15, label: 'PRESERVE' };
    }

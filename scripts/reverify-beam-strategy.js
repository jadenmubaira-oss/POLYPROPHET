...
const STRATEGY_REL_PATH = String(process.env.VERIFY_STRATEGY_PATH || 'strategies/strategy_set_15m_combined_sub50c_tight.json').trim();
...
const ENTRY_PRICE_BUFFER_CENTS = Number(process.env.VERIFY_ENTRY_PRICE_BUFFER_CENTS ?? CONFIG?.RISK?.entryPriceBufferCents ?? 0);
const MAX_PER_CYCLE = Math.max(1, parseInt(process.env.VERIFY_MAX_PER_CYCLE || '1', 10));
